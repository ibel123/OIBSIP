...
This repository contains my completed tasks for the Oasis Infobyte Summer Internship Program (OIBSIP), Data Science track.

## About the internship

Oasis Infobyte SIP is an AICTE approved internship program that provides practical, project based experience through a set of structured tasks. Each task is built, documented, and demonstrated end to end.
...
Python, pandas, numpy, matplotlib, seaborn, scikit learn, NLTK, Google Colab
